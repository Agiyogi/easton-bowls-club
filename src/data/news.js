...
export const NEWS = [
  {
    ...
    body: [
      ...
      "This was a win for the whole team. Led by captain Cliff Green, every rink pulled its weight — steady bowling from the front ends, precise strategy from the middle players, and the big shots at the back end all got us over the line. Cliff's calm on the green all season, and especially last night, set the tone for everyone.",
