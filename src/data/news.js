...
export const NEWS = [
  {
    ...
    body: [
      ...
      "It was also a win for the whole club. The A team stand on the shoulders of everyone at Easton — the B team and friendly-league players who push them in practice, and those who run the pavilion, the teas and the raffle week in, week out. None of last night happens without all of that.",
      "A very special thank you goes to Mike Cattermole, who has kept our green in such fine condition all year. Through a long, dry summer Mike has had the surface running true week after week, and a team only bowls as well as the green it practises on. This trophy is as much his as anyone's.",
